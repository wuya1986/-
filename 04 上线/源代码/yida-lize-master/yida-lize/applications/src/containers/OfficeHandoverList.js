...
class OfficeHandoverList extends Component {
  constructor(props) {
    super(props);
    this.state = {
      ticket_template: 'office_handover',
    };
  }
  componentDidMount() {
...
export default connect(mapStateToProps, mapDispatchToProps)(withRouter(OfficeHandoverList));
