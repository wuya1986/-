...
//http://localhost:3000/tickets/list/reserve_visit?token=JDJhJDEwJE1xc1ExWjc5dnhuNEpHazB5T0R5Yy41VnNZTFlOUGllbUd4dnU5SjFvQ3NuOXpaTjRSYUdP
  ...
  render() {
    ...
    return (
      <Page className="button" spacing>
                    ...
                    tickets.map((ticket, i) => (
                      ...
                      >
                        ...
                        <MediaBoxBody>
                          ...
                          <MediaBoxInfo>
                            <MediaBoxInfoMeta>{ticket.from_user ? ticket.from_user.fullname : ''}</MediaBoxInfoMeta>
        ...
        <ButtonArea>
          <Link to={`/tickets/new/${this.state.ticket_template}`}>
            <Button>添加</Button>
          </Link>
        </ButtonArea>
      </Page>
...
export default connect(mapStateToProps, mapDispatchToProps)(withRouter(TicketList));
